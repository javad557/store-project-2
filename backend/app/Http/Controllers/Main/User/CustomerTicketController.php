        ...
        public function my_tickets()
{
    try {
        ...
        $my_tickets = $user->tickets()->with([
            ...
            Log::info('mytickets',['mytickets'=>$my_tickets]);
        ...
        return response()->json([
            'error' => 'دریافت تیکت ها با خطا مواجه شد',
        ], 500);
    }
}
...
public function get_related_tickets(Ticket $ticket)
{
   ...
   public function mark_tickets_as_seen(Request $request)
    ...
    public function category_tickets(){
        // Log::info('testcategorytickets',['testcategorytickets'=>'yes']);
        try{
            ...
            Log::error($e->getMessage());
            return response()->json([
                'error'=>'دریافت دسته بندی های تیکت مورد نظر با خطا مواجه شد',
            ],500);
        }
    }


    public function priority_tickets(){
        // Log::info('testprioritytickets',['testprioritytickets'=>'yes']);
         try{
            ...
            Log::error($e->getMessage());
            return response()->json([
                'error'=>'دریافت اولویت های تیکت مورد نظر با خطا مواجه شد',
            ],500);
        }
    }

    public function create_ticket(Request $request){
        Log::info('testcreateticket',['testcreateticket'=>$request->all()]);
